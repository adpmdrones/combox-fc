...
while True:
	...
	schedule.every(1).minutes.do(windy_schedule(True, config.url_device, config.windy_token, data_gps_int["lat"] / 10000000, data_gps_int["lon"] / 10000000, float("{:.4f}".format(data_pressure["press_abs"]))))
